...
(function (global, factory) {
	...
	(global.WaveStreamLayer = factory(global.ol));
}(this, (function (ol) { 'use strict';

ol = ol && ol.hasOwnProperty('default') ? ol['default'] : ol;

var Windy = function Windy(params) {
  var VELOCITY_SCALE = 0.04 * (Math.pow(window.devicePixelRatio, 1 / 3) || 1);
  var MIN_WAVEH_MS =0.1;
  var MAX_WAVEH_MS = 12;
  var MAX_PARTICLE_AGE = 80;
  var PARTICLE_LINE_WIDTH = 9;
  var PARTICLE_MULTIPLIER = 1 / 500.0;
  ...
  var interpolateField = function interpolateField(grid, bounds, extent, callback) {
    ...
    var velocityScale = VELOCITY_SCALE * Math.pow(mapArea, 0.2);
  ...
  var animate = function animate(bounds, field, extent) {
    ...
    function windTemperatureColorScale(minTemp, maxTemp) {
      var result = [
        "rgba(100,240, 230, 0.75)",
        "rgba(60,210, 210, 0.8)",
        "rgba(20,200,200, 0.85 )",
        "rgba(190,180,60, 0.95)",
        "rgba(200,120,40, 0.95)",
        "rgba(220,30,205, 0.95)",
        "rgba(235,30,195, 1.0)",
        "rgba(240,20,150, 1.0)",
        "rgba(250,20,100, 1.0)",
        "rgba(255,20,60, 1.0)",
      ...
      //    "rgb(36,104, 180, 0.65)",
      //    "rgb(60,157, 194, 0.75)",
      //    "rgb(128,205,193, 0.75 )",
      //    "rgb(151,218,168, 0.8 )",
      //    "rgb(198,231,181, 0.85)",
      //    "rgb(238,247,217, 0.9)",
      //    "rgb(255,238,159, 0.95)",
      //    "rgb(252,217,125, 0.95)",
      //    "rgb(255,182,100, 1.0)",
      //    "rgb(252,150,75, 1.0)",
      //    "rgb(250,112,52, 1.0)",
      //    "rgb(245,64,32, 1.0)",
    ...
    var colorStyles = windTemperatureColorScale(MIN_WAVEH_MS, MAX_WAVEH_MS);
    ...
    var gl = params.canvas.getContext('webgl');
