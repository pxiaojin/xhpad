...
(function (global, factory) {
	...
	(global.CurrentLayer = factory(global.ol));
}(this, (function (ol) { 'use strict';

ol = ol && ol.hasOwnProperty('default') ? ol['default'] : ol;

var Windy = function Windy(params) {
  var VELOCITY_SCALE = 0.08 * (Math.pow(window.devicePixelRatio, 1 / 3) || 1);
  ...
  var PARTICLE_LINE_WIDTH = 2.0;
  var PARTICLE_MULTIPLIER = 1 / 150;
  ...
  var animate = function animate(bounds, field, extent) {
    ...
    function windTemperatureColorScale(minTemp, maxTemp) {
      var result = [
          ...
          "rgba(238,247,217,0.9)",
          "rgba(255,238,159,0.9)",
          "rgba(252,217,125,0.9)",
          "rgba(255,182,100,0.95)",
          "rgba(252,150,75,1.0)",
          "rgba(250,112,52,1.0)",
          "rgba(245,64,32,1.0)",
          "rgba(237,45,28,1.0)",
